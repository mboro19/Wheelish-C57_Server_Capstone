  ...
  return getToken().then((token) => {
    return fetch(apiUrl + `/getVehicleById/${id}`, {
      ...
      if (res.ok) {
        ...
        throw new Error("An error occurred at getVehicleById.");
      }
    });
  });
};
  ...
  return getToken().then((token) => {
    return fetch(apiUrl, {
      ...
      if (resp.ok) {
        ...
        throw new Error("An unknown error occurred @ getAllVehicles.");
      }
    });
  });
};
...
export const getVehiclesList = () => {
  return fetch(apiUrl + `/GetAll`, {
    ...
    if (res.ok) {
      ...
      throw new Error("An unknown error occurred @ getVehiclesList.");
    }
  });
};
  ...
  return getToken().then((token) => {
    return fetch(apiUrl, {
      ...
      if (res.status === 401) {
        ...
        throw new Error("An unknown error occurred @ add vehicle");
      }
    });
  });
};
